...
Credentials and temporary device state are stored as a AES-256-GCM PrestaShop Configuration value keyed from _COOKIE_KEY_. Saved secrets are not rendered back into the administration page.
